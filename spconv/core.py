...
_BF16_DTYPES_F32_ACC = ["bf16,bf16,bf16,f32,f32"]
_BF16_DTYPES = ["bf16,bf16,bf16,bf16,bf16"]
if not SPCONV_ADD_BF16:
    _BF16_DTYPES_F32_ACC = []
    _BF16_DTYPES = []
...
SHUFFLE_SIMT_PARAMS: List[GemmAlgoParams] = [
    ...
    *gen_shuffle_params((128, 128, 8), (32, 64, 8), [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                        [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2, kernel.GemmAlgo.Simt, None),
    *gen_shuffle_params((32, 64, 32), (32, 32, 8), [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                        [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2, kernel.GemmAlgo.Simt, None),
    *gen_shuffle_params((32, 32, 32), (32, 32, 8), [*_BF16_DTYPES_F32_ACC],
                        [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2, kernel.GemmAlgo.Simt, None),
    # *gen_shuffle_params(
    #     (64, 64, 16),
    #     (32, 32, 8), ["f16,f16,f16,f16,f16"], "bf16,bf16,bf16,f32,f32", 2, kernel.GemmAlgo.Simt, None),
    *gen_shuffle_params((64, 128, 16), (32, 64, 8), [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                        [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2, kernel.GemmAlgo.Simt, None),
    *gen_shuffle_params((64, 64, 8), (32, 32, 8), [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                        [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2, kernel.GemmAlgo.Simt, None),
]
...
SHUFFLE_TURING_PARAMS: List[GemmAlgoParams] = [
    *gen_shuffle_params(
        (64, 64, 32),
        (32, 32, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
        kernel.GemmAlgo.Turing, TensorOp((16, 8, 8))),
    *gen_shuffle_params(
        (128, 128, 32),
        (32, 64, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
        kernel.GemmAlgo.Turing, TensorOp((16, 8, 8))),
    # *gen_shuffle_params(
    #     (128, 128, 32),
    #     (64, 32, 32), ["f16,f16,f16,f16,f16"], *_BF16_DTYPES_F32_ACC, 2,
    #     kernel.GemmAlgo.Turing, TensorOp((16, 8, 8))),
    *gen_shuffle_params(
        (64, 64, 64),
        (32, 32, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
    ...
    *gen_shuffle_params(
        (128, 256, 32),
        (64, 64, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
        kernel.GemmAlgo.Turing, TensorOp((16, 8, 8))),
    *gen_shuffle_params(
        (256, 128, 32),
        (64, 64, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
    ...
    *gen_shuffle_params(
        (128, 64, 32),
        (64, 32, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
        kernel.GemmAlgo.Turing, TensorOp((16, 8, 8))),
    *gen_shuffle_params(
        (64, 128, 32),
        (32, 64, 32), ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32", *_BF16_DTYPES_F32_ACC], [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"], 2,
...
# here we must use f32 for simt bf16 accumulators because
...
IMPLGEMM_SIMT_PARAMS = [
    *gen_conv_params(ConvFwdAndBwdInput, (32, 128, 16), (32, 32, 8),
                     ...
                     2, ["f32,f32,f32,f32,f32", *_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                     NHWC,
                     NHWC,
                     NHWC,
                     GemmAlgo.Simt,
...
IMPLGEMM_AMPERE_PARAMS = [
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (64, 128, 32), (32, 64, 32),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     [2, 3, 4], ["f16,f16,f16,f16,f16", *_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                     NHWC,
                     NHWC,
                     NHWC,
                     GemmAlgo.Ampere,
    ...
    *gen_conv_params(ConvBwdWeight, (64, 128, 32), (32, 64, 32),
                     ...
                     ConvIterAlgo.Optimized,
                     [2, 3, 4],
                     [*_BF16_DTYPES_F32_ACC, "f16,f16,f16,f32,f32"],
                     NHWC,
                     NHWC,
                     NHWC,
                     GemmAlgo.Ampere,
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (64, 64, 32), (32, 32, 32),
                    ...
                    ConvIterAlgo.Optimized,
                    [2, 3, 4],
                    ["s8,s8,s8,s32,f32", "s8,s8,s8,s32,f16", "s8,s8,f32,s32,f32", "s8,s8,f32,s32,f16", "s8,s8,f16,s32,f32", "s8,s8,bf16,s32,f16"],
                    NHWC,
                    NHWC,
                    NHWC,
                    GemmAlgo.Ampere,
...
IMPLGEMM_TURING_PARAMS = [
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (32, 16, 16), (16, 16, 16),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2, ["f16,f16,f16,f16,f16", *_BF16_DTYPES_F32_ACC],
                     NHWC,
                     NHWC,
                     NHWC,
                     GemmAlgo.Turing,
    ...
    *gen_conv_params(ConvBwdWeight, (64, 16, 32), (32, 16, 32),
    ...
    # *gen_conv_params(ConvBwdWeight, (32, 64, 32), (32, 32, 16), NDIM_DONT_CARE, ConvIterAlgo.Optimized, 2, "bf16,bf16,bf16,f32,f32",
